...
const AboutUs = () => {
    return (
        <>
         ...
         <section className='aboutfit grid grid-cols-1 md:grid-cols-2 gap-10 mx-10 mt-14'>
           <div className='textbox1 rounded-lg bg-[#E6E1FF] text-[#191F5D] w-[auto] h-[auto] order-2 sm:order-1'>
             <h1 className='text-3xl md:text-5xl font-black mt-20 ml-7'>{AboutA.head}</h1>
             ...
             {AboutImgSet.map((img, index) => (
               ...
               <img src={img.img} alt={`Image ${index}`} className='w-10 h-10 md:w-12 md:h-12'/>
               </div>))} 
             </div>
          </div>
           <img src={aboutimg} alt='about image' className='w-[500px] h-[auto] rounded-lg order-1 sm:order-2'/>
         </section>
         
         <section className='team'>
            <div className='textbox2 bg-[#E3BBFF] text-[#191F5D] text-center font-black text-3xl md:text-5xl w-full h-full mt-10'>About Us</div>
         </section>
         ...
         <section className='profile1 grid grid-cols-1 md:grid-cols-3 gap-5 mx-10 mt-5 mb-5'>
          ...
          <div className='profbox1 col-span-1 rounded-lg bg-[#E6E1FF] text-[#191F5D] w-full h-full'>
            ...
            <div className='txtprof1 text-xl font-bold text-center md:text-2xl my-2'>{Prof1.head}</div>
            <div className='contact flex flex-row justify-center mb-5'>
               <a href={Prof1.link1} target='_blank'>
                  <img src={linkedin} alt='linkedin image' className='object-cover w-10 h10 mr-5 hover:scale-105'/>
               </a>
               <a href={Prof1.link2} target='_blank'>
                  <img src={portfolio} alt='linkedin image' className='object-cover w-10 h10 mr-5 hover:scale-105'/>
               </a>
               <a href={Prof1.link3} target='_blank'>
                  <img src={github} alt='linkedin image' className='object-cover w-10 h10 hover:scale-105'/>
               </a>
            </div>
          </div>
          ...
          <div className='profbox2 col-span-1 rounded-lg bg-[#E6E1FF] text-[#191F5D] w-full h-full'>
            ...
            <div className='txtprof2 text-xl font-bold text-center md:text-2xl my-2'>{Prof2.head}</div>
            <div className='contact flex flex-row justify-center mb-5'>
          ...
          <div className='profbox3 col-span-1 rounded-lg bg-[#E6E1FF] text-[#191F5D] w-full h-full'>
            ...
            <div className='txtprof1 text-xl font-bold text-center md:text-2xl my-2'>{Prof3.head}</div>
            <div className='contact flex flex-row justify-center mb-5'>
          ...
          <div className='profbox4 col-span-3 md:col-span-2 rounded-lg bg-[#E6E1FF] text-[#191F5D] w-full h-full'>
            ...
            <div className='txtprof1 text-xl font-bold text-center md:text-2xl my-2'>{Prof4.head}</div>
            <div className='contact flex flex-row justify-center mb-5'>
          ...
          <div className='profbox5 rounded-lg bg-[#E6E1FF] text-[#191F5D] w-full h-full md:w-2/3'>
            ...
            <div className='txtprof1 text-xl font-bold text-center md:text-2xl my-2'>{Prof5.head}</div>
            <div className='contact flex flex-row justify-center mb-5'>
