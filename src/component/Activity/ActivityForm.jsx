      ...
      <div className="flex flex-col items-center">
        ...
        <form onSubmit={saveData} className="m-1 mt-3">
          ...
          <div className="max-w-[378px] h-[58px] my-2 flex bg-gray-200 ">
            <label
              htmlFor="type"
              className="w-[188px] flex items-center justify-center"
            >
              Activity Type:
            </label>
            ...
            >
              ...
              <option value="KitaMuaythai">Kita Muaythai</option>
              <option value="Training">Weight Training</option>
            </select>
          </div>
          <label className="max-w-[378px] h-[58px] my-2 flex bg-gray-200">
            <span className="w-[188px]  flex items-center justify-center  bg-gray-200">
              คำอธิบายกิจกรรม
            </span>
            <input
              value={descrition}
          ...
          <button
            type="submit"
            className="w-[154px] h-[58px] border mt-4 bg-green-800 text-white rounded-lg shadow-md text-2xl"
          >
            CONFIRM
          </button>
        </form>
